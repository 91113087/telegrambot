...
if($msgType=='video'){
 ...
 $telegram->buildInlineKeyBoardButton("دکمه 1", $url="http://link1.com"), $telegram->buildInlineKeyBoardButton("دکمه 2", $url="http://link2.com")
     ...
     //Second row 
  array(
  $telegram->buildInlineKeyBoardButton("Button 3", $url="tel:0123456789"), $telegram->buildInlineKeyBoardButton("Button 4", $url="http://link4.com"), $telegram->buildInlineKeyBoardButton("@Mohsen322", $url="http://link5.com")
  ),
     //Third row
   array(
